                ...
                if (basePathArr.length > 1) {
                    ...
                    if (importStatements) {
                        for (var i in importStatements) {
                            ...
                            console.log('moduleName in response.jsContent');
                            console.log(moduleName in response.jsContent);
                            if (!(moduleName in response.jsContent))
                            {
...
var combineJs = function(response, em) {
    ...
    em.on('import_js_succ', function(name, content) {
        ...
        response.jsContent[name] = content;
        ...
        if (0 == response.jsCount) {
            ...
            var responseContent = '';
            for (var m in response.jsContent) {
                responseContent = responseContent + response.jsContent[m];
            }
